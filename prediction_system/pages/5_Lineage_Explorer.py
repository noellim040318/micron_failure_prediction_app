...
st.subheader("Trajectory Shapley Attribution Importance: Raw Process vs Lineage Features")
...
lineage_feature_names = [
    ...
    "days_since_last_pm", "tool_pm_urgency", "lot_std_tcb_force",
    "moisture_z_in_lot", "tcb_force_z_in_lot", "attach_temp_z_in_lot",
    "time_since_lot_start_norm", "lot_mean_attach_temp", "lot_mean_tcb_force",
]
...
fig_comp = px.bar(
    ...
    labels={"importance": "Trajectory Shapley Attribution Importance (Gain)", "feature": "Feature",
             "type": "Feature Type"},
)
