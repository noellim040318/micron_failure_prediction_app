...
st.title("⚙️ Model Settings & Retraining")
...
with tab_cost:
    ...
    st.markdown("""
    The cost-aligned threshold is derived from the economics of two error types:

    | Error Type | Business Impact |
    |---|---|
    | **False Negative** (missed defect) | Field return: repair + logistics + warranty claim + NPS damage |
    | **False Positive** (false alarm) | Unnecessary re-test, hold queue, engineering review time |
