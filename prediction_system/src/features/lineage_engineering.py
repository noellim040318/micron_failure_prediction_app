...
LINEAGE_FEATURE_DESCRIPTIONS = {
    ...
    "lot_mean_tcb_force": "lot-average TCB bonding force (Thermal Compression Bonding)",
    "lot_std_tcb_force": "within-lot variability of TCB bonding force",
    ...
    "tcb_force_z_in_lot": "TCB bonding force deviation within lot (z-score)",
...
def engineer_lineage_features(df: pd.DataFrame) -> pd.DataFrame:
    ...
    for col, out_name in [
        ("tcb_bond_force_n", "tcb_force_z_in_lot"),
