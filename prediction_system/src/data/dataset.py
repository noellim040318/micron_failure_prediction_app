...
def load_dataset(n_samples: int = 3000, seed: int = 42, failure_rate: float = 0.04) -> pd.DataFrame:
    return generate_synthetic_dataset(n_samples=n_samples, seed=seed, failure_rate=failure_rate)
