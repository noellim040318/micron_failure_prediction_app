...
# Absolute paths — resolved relative to this file so CWD of the Streamlit
# process does not affect where artifacts are saved/loaded.
_MODELS_DIR = Path(__file__).resolve().parent.parent.parent / "models"
MODEL_PATH    = _MODELS_DIR / "xgboost_model.joblib"
PIPELINE_PATH = _MODELS_DIR / "preprocessing_pipeline.joblib"
SHAP_PATH     = _MODELS_DIR / "shap_engine.joblib"
...
def load_artifacts() -> dict:
    ...
    try:
        ...
        if not _REQUIRED_FEATURES.issubset(feature_cols):
            ...
            for p in [MODEL_PATH, PIPELINE_PATH, SHAP_PATH, DRIFT_PATH, METADATA_PATH]:
