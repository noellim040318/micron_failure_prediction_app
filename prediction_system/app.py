...
def main():
    ...
    st.caption(
        "Edge-Deployed XGBoost · SMOTE · SHAP Attribution · Lineage Features · Concept Drift Monitoring  |  "
    ...
    st.info(
        ...
        *(Bridges the 6-week factory test → 5-year warranty gap)*
        ...
        3. **SHAP Attribution Module** — SHAP TreeExplainer with sequential process ordering and an
